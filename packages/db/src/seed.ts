...
const PERMISSION_DESCRIPTIONS: Record<string, string> = {
  ...
  "attendance.clock": "Clock in/out for oneself",
  "attendance.request_correction": "Request a correction to one's own attendance record",
  "attendance.shift.manage": "Manage shift templates and employee shift assignments",
  ...
  "recruitment.interview.conduct": "Record feedback for interviews one is assigned to conduct",
  "performance.review": "Submit reviews for direct reports",
  "performance.review_all": "Submit reviews for any employee",
  "performance.view": "View one's own and direct reports' goals and reviews",
  "performance.view_all": "View any employee's goals and reviews",
  "performance.goal.set": "Create and update one's own goals",
